...
> **Source status:** this README documents current source after ProjectForge v0.7.0. Use the
> documentation bundled with an immutable release for that release's exact behavior.
...
The post-v0.7.0 behavior documented below is available from the current repository checkout:
