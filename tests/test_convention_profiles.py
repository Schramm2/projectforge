...
from ubundiforge.convention_profiles import import_profile, initialize_profile, list_profiles


def test_initialize_profile_creates_stable_default_without_overwrite(monkeypatch, tmp_path):
    monkeypatch.setattr("ubundiforge.convention_profiles.PROFILES_DIR", tmp_path / "profiles")
